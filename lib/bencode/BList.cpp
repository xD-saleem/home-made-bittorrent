 ...
 */
BList::size_type BList::size() const { return itemList.size(); }
 ...
 */
BList::iterator BList::begin() { return itemList.begin(); }

/**
 * @brief Returns an iterator to the end of the list.
 */
BList::iterator BList::end() { return itemList.end(); }

/**
 * @brief Returns a constant iterator to the beginning of the list.
 */
BList::const_iterator BList::begin() const { return itemList.begin(); }

/**
 * @brief Returns a constant iterator to the end of the list.
 */
BList::const_iterator BList::end() const { return itemList.end(); }

/**
 * @brief Returns a constant iterator to the beginning of the list.
 */
BList::const_iterator BList::cbegin() const { return itemList.cbegin(); }

/**
 * @brief Returns a constant iterator to the end of the list.
 */
BList::const_iterator BList::cend() const { return itemList.cend(); }
  ...
  for (const auto& item : *this) {
    if (typeid(*item) == typeid(BDictionary)) {
      std::shared_ptr<BDictionary> subDictionary =
          std::dynamic_pointer_cast<BDictionary>(item);
