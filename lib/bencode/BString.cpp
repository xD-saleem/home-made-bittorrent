 ...
 */
auto BString::value() const -> ValueType { return _value; }

/**
 * @brief Sets a new value.
 */
void BString::setValue(ValueType value) { _value = value; }

/**
 * @brief Returns the number of characters in the string.
 */
auto BString::length() const -> ValueType::size_type { return _value.length(); }
